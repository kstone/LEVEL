...
implementation
{
    ...
    void task sendRedPacket(){
        ...
        ptrpkt->data[ChannelNo] = 0x0000;
        ptrpkt->data[ChannelNo+1] = 0xDEAD;  /* This is for error checking */
    ...
    void task sendGreenPacket(){
        ...
        /* TODO: add universal time reading in ChannelNo 1 */
        SenseToRadioMsg* ptrpkt = (SenseToRadioMsg*)(call Packet.getPayload(&pkt, len));
        ptrpkt->data[ChannelNo] = 0x1111;
        ptrpkt->data[ChannelNo +1] = 0xDEAD;  /* This is for error checking */
