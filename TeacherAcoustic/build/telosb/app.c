...
# 40 "/stow/lib/gcc-lib/../../msp430/include/string.h" 3
extern void *memset(void *arg_0x797690, int arg_0x7977e8, size_t arg_0x797980);
#line 61
extern void *memset(void *arg_0x7a7650, int arg_0x7a77a8, size_t arg_0x7a7940);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0x7d5ab8);
  ...
  void (**_sig_func)(int arg_0x7d9c98);
...
union __dmath;
#line 145
extern float sqrtf(float arg_0x10165e0);
#line 208
struct exception {
...
struct adc12_t;
# 83 "/stow/lib/gcc-lib/../../msp430/include/msp430x16x.h" 3
...
# 52 "/stow/lib/gcc-lib/../../msp430/include/stdio.h" 3
...
typedef TMilli SenseAcousticC$SpeechTimer$precision_tag;
typedef uint16_t SenseAcousticC$ReadMIC$val_t;
typedef TMilli SenseAcousticC$WakeupTimer$precision_tag;
typedef TMilli SenseAcousticC$CalibrationTimer$precision_tag;
...
enum SerialAMQueueP$__nesc_unnamed4297 {
...
enum /*HilTimerMilliC.AlarmMilli32C.AlarmFrom.Msp430Timer*/Msp430Timer32khzC$0$__nesc_unnamed4298 {
...
enum /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$__nesc_unnamed4299 {
  Msp430Adc12ClientAutoRVGC$0$ID = 0U
};
typedef const msp430adc12_channel_config_t */*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfSub$adc_config_t;
typedef const msp430adc12_channel_config_t */*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfUp$adc_config_t;
enum /*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$__nesc_unnamed4300 {
  AdcReadClientC$0$CLIENT = 0U
};
typedef const msp430adc12_channel_config_t *SBT80_ADCconfigP$ADC1$adc_config_t;
enum CC2420ActiveMessageC$__nesc_unnamed4301 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.AlarmC.Msp430Timer*/Msp430Timer32khzC$1$__nesc_unnamed4302 {
...
enum /*CC2420ReceiveC.Spi*/CC2420SpiC$4$__nesc_unnamed4309 {
  CC2420SpiC$4$CLIENT_ID = 4U
};
typedef uint16_t RandomMlcgC$SeedInit$parameter;
enum CC2420TinyosNetworkC$__nesc_unnamed4310 {
...
static void SenseAcousticC$AMControl$startDone(error_t error);
#line 117
static void SenseAcousticC$AMControl$stopDone(error_t error);
# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static void SenseAcousticC$Boot$booted(void );
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void SenseAcousticC$getData$runTask(void );
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void SenseAcousticC$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void SenseAcousticC$sendGreenPacket$runTask(void );
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void SenseAcousticC$SpeechTimer$fired(void );
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void SenseAcousticC$calibrateAcoustic$runTask(void );
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static void SenseAcousticC$ReadMIC$readDone(error_t result, SenseAcousticC$ReadMIC$val_t val);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void SenseAcousticC$sendRedPacket$runTask(void );
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void SenseAcousticC$WakeupTimer$fired(void );
#line 72
static void SenseAcousticC$CalibrationTimer$fired(void );
...
#line 85
static void /*HplMsp430GeneralIOC.P23*/HplMsp430GeneralIOP$11$IO$selectIOFunc(void );
#line 39
...
# 58 "/opt/tinyos-2.x/tos/interfaces/AdcConfigure.nc"
static /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfSub$adc_config_t /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfSub$getConfiguration(void );
#line 58
static SBT80_ADCconfigP$ADC1$adc_config_t SBT80_ADCconfigP$ADC1$getConfiguration(void );
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
...
uint8_t arg_0x262a7d0);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t CC2420TinyosNetworkP$BareSend$send(
#line 56
message_t * msg, 
...
uint8_t len);
#line 101
static uint8_t CC2420TinyosNetworkP$BareSend$maxPayloadLength(void );
#line 89
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static void /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(
#line 85
message_t * msg, 
...
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t SenseAcousticC$AMControl$start(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t SenseAcousticC$getData$postTask(void );
...
SenseAcousticC$Packet$getPayload(
#line 110
message_t * msg, 
...
uint8_t len);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t SenseAcousticC$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t SenseAcousticC$sendGreenPacket$postTask(void );
# 81 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static bool SenseAcousticC$SpeechTimer$isRunning(void );
#line 62
static void SenseAcousticC$SpeechTimer$startOneShot(uint32_t dt);




static void SenseAcousticC$SpeechTimer$stop(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t SenseAcousticC$calibrateAcoustic$postTask(void );
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static error_t SenseAcousticC$ReadMIC$read(void );
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t SenseAcousticC$sendRedPacket$postTask(void );
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void SenseAcousticC$WakeupTimer$startPeriodic(uint32_t dt);
# 71 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430GeneralIO.nc"
static void SenseAcousticC$SBcontrol$makeOutput(void );
#line 85
static void SenseAcousticC$SBcontrol$selectIOFunc(void );
#line 39
static void SenseAcousticC$SBcontrol$clr(void );
# 50 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void SenseAcousticC$Leds$led0Off(void );
...
static void SenseAcousticC$Leds$led1On(void );




static void SenseAcousticC$Leds$led1Off(void );
#line 83
static void SenseAcousticC$Leds$led2Off(void );
#line 45
static void SenseAcousticC$Leds$led0On(void );
#line 78
static void SenseAcousticC$Leds$led2On(void );
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void SenseAcousticC$CalibrationTimer$startOneShot(uint32_t dt);
# 81 "SenseAcousticC.nc"
enum SenseAcousticC$__nesc_unnamed4312 {
#line 81
  SenseAcousticC$getData = 0U
};
#line 81
typedef int SenseAcousticC$__nesc_sillytask_getData[SenseAcousticC$getData];

enum SenseAcousticC$__nesc_unnamed4313 {
#line 83
  SenseAcousticC$sendRedPacket = 1U
};
#line 83
typedef int SenseAcousticC$__nesc_sillytask_sendRedPacket[SenseAcousticC$sendRedPacket];
enum SenseAcousticC$__nesc_unnamed4314 {
#line 84
  SenseAcousticC$sendGreenPacket = 2U
};
#line 84
typedef int SenseAcousticC$__nesc_sillytask_sendGreenPacket[SenseAcousticC$sendGreenPacket];

enum SenseAcousticC$__nesc_unnamed4315 {
#line 86
  SenseAcousticC$calibrateAcoustic = 3U
};
#line 86
typedef int SenseAcousticC$__nesc_sillytask_calibrateAcoustic[SenseAcousticC$calibrateAcoustic];
#line 73
uint16_t SenseAcousticC$ChannelNo = 0;




uint8_t SenseAcousticC$len;
bool SenseAcousticC$busy = FALSE;
message_t SenseAcousticC$pkt;
...
bool SenseAcousticC$calibrating = FALSE;
uint32_t SenseAcousticC$calibrationData = 0;
uint32_t SenseAcousticC$calibrationArray[30];
uint32_t SenseAcousticC$calibrationAverage = 0;
uint32_t SenseAcousticC$calibrationIndex = 0;
uint32_t SenseAcousticC$index = 0;
uint32_t SenseAcousticC$stddev = 0;
uint32_t SenseAcousticC$upperBound = 0;
uint32_t SenseAcousticC$lowerBound = 0;


static inline void SenseAcousticC$Boot$booted(void );
#line 116
static inline void SenseAcousticC$WakeupTimer$fired(void );
...
static inline void SenseAcousticC$CalibrationTimer$fired(void );
#line 157
static inline void SenseAcousticC$SpeechTimer$fired(void );




static inline void SenseAcousticC$AMControl$startDone(error_t err);


static inline void SenseAcousticC$AMControl$stopDone(error_t err);



static void SenseAcousticC$AMSend$sendDone(message_t *msg, error_t error);
...
static inline void SenseAcousticC$calibrateAcoustic$runTask(void );
...
static inline void SenseAcousticC$getData$runTask(void );




static inline void SenseAcousticC$sendRedPacket$runTask(void );
#line 210
static inline void SenseAcousticC$sendGreenPacket$runTask(void );
#line 227
static void SenseAcousticC$ReadMIC$readDone(error_t result, uint16_t data);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
#line 109
typedef enum SerialP$__nesc_unnamed4325 {
...
#line 55
#line 51
typedef enum /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$__nesc_unnamed4332 {
...
enum /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$__nesc_unnamed4333 {
...
#line 63
typedef struct /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$__nesc_unnamed4334 {
  uint8_t which : 1;
...
#line 44
typedef struct HdlcTranslateC$__nesc_unnamed4335 {
...
#line 46
static inline void /*HplMsp430GeneralIOC.P23*/HplMsp430GeneralIOP$11$IO$clr(void );
...
static inline void /*HplMsp430GeneralIOC.P23*/HplMsp430GeneralIOP$11$IO$selectIOFunc(void );
#line 54
...
enum /*Msp430UsartShare1P.ArbiterC.Queue*/FcfsResourceQueueC$1$__nesc_unnamed4336 {
#line 39
...
#line 69
enum /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$0$__nesc_unnamed4340 {
#line 69
...
enum Msp430Adc12ImplP$__nesc_unnamed4354 {
...
const msp430adc12_channel_config_t *config);
#line 394
static inline error_t Msp430Adc12ImplP$SingleChannel$getData(uint8_t id);
#line 503
...
enum /*Msp430Adc12P.Arbiter.Queue*/RoundRobinResourceQueueC$0$__nesc_unnamed4355 {
...
enum /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$__nesc_unnamed4356 {
#line 69
...
#line 62
enum /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$__nesc_unnamed4357 {
#line 62
  SimpleArbiterP$0$RES_IDLE = 0, SimpleArbiterP$0$RES_GRANTING = 1, SimpleArbiterP$0$RES_BUSY = 2
};
#line 63
enum /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$__nesc_unnamed4358 {
#line 63
...
#line 52
typedef enum Msp430RefVoltGeneratorP$__nesc_unnamed4359 {
...
enum Msp430RefVoltArbiterImplP$__nesc_unnamed4360 {
#line 51
  Msp430RefVoltArbiterImplP$switchOff = 18U
};
#line 51
typedef int Msp430RefVoltArbiterImplP$__nesc_sillytask_switchOff[Msp430RefVoltArbiterImplP$switchOff];
#line 46
enum Msp430RefVoltArbiterImplP$__nesc_unnamed4361 {
...
#line 70
static inline void Msp430RefVoltArbiterImplP$AdcResource$granted(uint8_t client);
#line 98
...
# 58 "/opt/tinyos-2.x/tos/interfaces/AdcConfigure.nc"
static /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfUp$adc_config_t /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfUp$getConfiguration(void );
# 47 "/opt/tinyos-2.x/tos/chips/msp430/adc12/Msp430Adc12ConfAlertC.nc"
static inline const msp430adc12_channel_config_t */*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfSub$getConfiguration(void );
# 21 "SBT80_ADCconfigP.nc"
const msp430adc12_channel_config_t SBT80_ADCconfigP$config_ADC1 = { 
...
static inline const msp430adc12_channel_config_t *SBT80_ADCconfigP$ADC1$getConfiguration(void );
# 92 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
...
enum /*Counter32khz32C.Transform*/TransformCounterC$1$__nesc_unnamed4369 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform*/TransformAlarmC$1$__nesc_unnamed4370 {
...
enum StateImplP$__nesc_unnamed4374 {
  StateImplP$S_IDLE = 0
};
...
enum /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$__nesc_unnamed4375 {
#line 67
  Msp430SpiNoDmaP$0$signalDone_task = 25U
};
#line 67
...
#line 56
enum /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$__nesc_unnamed4376 {
...
# 39 "/opt/tinyos-2.x/tos/system/FcfsResourceQueueC.nc"
enum /*Msp430UsartShare0P.ArbiterC.Queue*/FcfsResourceQueueC$2$__nesc_unnamed4377 {
#line 39
...
# 75 "/opt/tinyos-2.x/tos/system/ArbiterP.nc"
enum /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$__nesc_unnamed4378 {
#line 75
...
#line 67
enum /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$__nesc_unnamed4379 {
#line 67
  ArbiterP$1$RES_CONTROLLED, ArbiterP$1$RES_GRANTING, ArbiterP$1$RES_IMM_GRANTING, ArbiterP$1$RES_BUSY
};
#line 68
enum /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$__nesc_unnamed4380 {
#line 68
  ArbiterP$1$default_owner_id = 1U
};
#line 69
enum /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$__nesc_unnamed4381 {
#line 69
...
#line 89
typedef enum CC2420TransmitP$__nesc_unnamed4382 {
...
enum CC2420TransmitP$__nesc_unnamed4383 {
...
#line 89
#line 81
typedef enum CC2420ReceiveP$__nesc_unnamed4385 {
...
enum CC2420ReceiveP$__nesc_unnamed4386 {
...
enum UniqueSendP$__nesc_unnamed4387 {
  UniqueSendP$S_IDLE, 
...
#line 56
struct UniqueReceiveP$__nesc_unnamed4388 {
  am_addr_t source;
  uint8_t dsn;
...
enum UniqueReceiveP$__nesc_unnamed4389 {
...
enum CC2420TinyosNetworkP$__nesc_unnamed4390 {
#line 138
  CC2420TinyosNetworkP$grantTask = 28U
};
#line 138
typedef int CC2420TinyosNetworkP$__nesc_sillytask_grantTask[CC2420TinyosNetworkP$grantTask];
#line 66
enum CC2420TinyosNetworkP$__nesc_unnamed4391 {
...
static inline error_t CC2420TinyosNetworkP$BareSend$send(message_t *msg, uint8_t len);
...
static inline uint8_t CC2420TinyosNetworkP$BareSend$maxPayloadLength(void );
...
# 39 "/opt/tinyos-2.x/tos/system/FcfsResourceQueueC.nc"
enum /*CC2420TinyosNetworkC.FcfsResourceQueueC*/FcfsResourceQueueC$0$__nesc_unnamed4392 {
#line 39
...
message_t *msg);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(
#line 56
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static void /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static error_t /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
# 28 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$fired(uint8_t arg_0x15704b0){
#line 28
  switch (arg_0x15704b0) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$default$fired(arg_0x15704b0);
#line 28
      break;
#line 28
    }
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA0*/Msp430TimerCapComP$0$__nesc_unnamed4396 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerA2*/Msp430TimerCapComP$2$__nesc_unnamed4398 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB0*/Msp430TimerCapComP$3$__nesc_unnamed4399 {
#line 47
    uint16_t f;
#line 47
...
#line 55
# 116 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static inline cc2420_header_t * CC2420PacketP$CC2420PacketBody$getHeader(message_t * msg)
#line 116
{
...
# 187 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static inline uint8_t CC2420PacketP$PacketTimeSyncOffset$get(message_t *msg)
{
...
# 120 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static inline cc2420_metadata_t *CC2420PacketP$CC2420PacketBody$getMetadata(message_t *msg)
#line 120
{
...
#line 39
# 145 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static inline void CC2420PacketP$PacketTimeStamp32khz$set(message_t *msg, uint32_t value)
{
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB1*/Msp430TimerCapComP$4$__nesc_unnamed4400 {
#line 47
    uint16_t f;
#line 47
...
{
#line 46
  union /*Msp430TimerC.Msp430TimerB1*/Msp430TimerCapComP$4$__nesc_unnamed4401 {
#line 46
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$ResourceConfigure$unconfigure(uint8_t arg_0x1ab8030){
#line 55
  switch (arg_0x1ab8030) {
#line 55
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$ResourceConfigure$default$unconfigure(arg_0x1ab8030);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$release(uint8_t arg_0x22609b0){
#line 110
  unsigned char result;
#line 110

#line 110
  switch (arg_0x22609b0) {
#line 110
...
#line 110
    default:
#line 110
      result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$release(arg_0x22609b0);
#line 110
      break;
#line 110
    }
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB2*/Msp430TimerCapComP$5$__nesc_unnamed4402 {
#line 47
    uint16_t f;
#line 47
...
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCongestionBackoff(am_id_t arg_0x267c230, message_t * msg){
#line 88
    CC2420ActiveMessageP$RadioBackoff$default$requestCongestionBackoff(arg_0x267c230, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$isOwner(uint8_t arg_0x22609b0){
#line 118
  unsigned char result;
#line 118
...
#line 118
    default:
#line 118
      result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$isOwner(arg_0x22609b0);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$getConfig(uint8_t arg_0x225e418){
#line 39
  union __nesc_unnamed4285 *result;
#line 39

#line 39
    result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$default$getConfig(arg_0x225e418);
#line 39
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$ResourceConfigure$configure(uint8_t arg_0x1ab8030){
#line 49
  switch (arg_0x1ab8030) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$ResourceConfigure$default$configure(arg_0x1ab8030);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$ResourceRequested$immediateRequested(uint8_t arg_0x1abbc58){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$ResourceRequested$default$immediateRequested(arg_0x1abbc58);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$immediateRequest(uint8_t arg_0x22609b0){
#line 87
  unsigned char result;
#line 87
...
#line 87
    default:
#line 87
      result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$immediateRequest(arg_0x22609b0);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$ResourceRequested$requested(uint8_t arg_0x1abbc58){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$ResourceRequested$default$requested(arg_0x1abbc58);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$request(uint8_t arg_0x22609b0){
#line 78
  unsigned char result;
#line 78
...
#line 78
    default:
#line 78
      result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$request(arg_0x22609b0);
#line 78
      break;
#line 78
    }
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB3*/Msp430TimerCapComP$6$__nesc_unnamed4403 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB4*/Msp430TimerCapComP$7$__nesc_unnamed4404 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB5*/Msp430TimerCapComP$8$__nesc_unnamed4405 {
#line 47
    uint16_t f;
#line 47
...
{
#line 47
  union /*Msp430TimerC.Msp430TimerB6*/Msp430TimerCapComP$9$__nesc_unnamed4406 {
#line 47
    uint16_t f;
#line 47
...
#line 54
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  SenseAcousticC$AMSend$sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$Send$sendDone(uint8_t arg_0x1b2f5d0, message_t * msg, error_t error){
#line 89
  switch (arg_0x1b2f5d0) {
#line 89
    case 0U:
#line 89
      /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$Send$default$sendDone(arg_0x1b2f5d0, msg, error);
#line 89
      break;
#line 89
    }
...
# 50 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void SenseAcousticC$Leds$led0Off(void ){
#line 50
  LedsP$Leds$led0Off();
#line 50
}
...
inline static void SenseAcousticC$Leds$led1Off(void ){
#line 66
  LedsP$Leds$led1Off();
#line 66
}
...
#line 56
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$AMSend$send(am_id_t arg_0x1b62010, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char result;
#line 69

#line 69
  result = CC2420ActiveMessageP$AMSend$send(arg_0x1b62010, addr, msg, len);
#line 69
...
#line 181
{
  return __nesc_ntoh_leuint8(CC2420ActiveMessageP$CC2420PacketBody$getHeader(msg)->length.data) - CC2420_SIZE - AM_OVERHEAD;
}
...
#line 101
  result = CC2420CsmaP$Send$maxPayloadLength();
#line 101
...
#line 101
  result = UniqueSendP$Send$maxPayloadLength();
#line 101
...
#line 101
# 103 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline uint8_t CC2420TinyosNetworkP$BareSend$maxPayloadLength(void )
#line 103
{
...
#line 82
{
  return CC2420TinyosNetworkP$BareSend$maxPayloadLength() - AM_OVERHEAD;
}
...
#line 101
  result = CC2420TinyosNetworkP$ActiveSend$maxPayloadLength();
#line 101
...
#line 43
  result = /*CC2420TinyosNetworkC.FcfsResourceQueueC*/FcfsResourceQueueC$0$FcfsQueue$isEmpty();
#line 43
...
#line 43
# 173 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline error_t CC2420TinyosNetworkP$Resource$immediateRequest(uint8_t id)
#line 173
{
...
#line 87
  result = CC2420TinyosNetworkP$Resource$immediateRequest(CC2420ActiveMessageC$CC2420_AM_SEND_ID);
#line 87
...
# 59 "/opt/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP$SendNotifier$aboutToSend(am_id_t arg_0x267eb78, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP$SendNotifier$default$aboutToSend(arg_0x267eb78, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
...
#line 64
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline error_t CC2420TinyosNetworkP$BareSend$send(message_t *msg, uint8_t len)
#line 95
{
...
#line 73
{
  ...
  return CC2420TinyosNetworkP$BareSend$send(msg, len + AM_OVERHEAD);
}
...
#line 64
  result = CC2420TinyosNetworkP$ActiveSend$send(msg, len);
#line 64
...
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCca(am_id_t arg_0x267c230, message_t * msg){
#line 95
    CC2420ActiveMessageP$RadioBackoff$default$requestCca(arg_0x267c230, msg);
#line 95
}
#line 95
...
#line 69
  result = /*CC2420TinyosNetworkC.FcfsResourceQueueC*/FcfsResourceQueueC$0$FcfsQueue$enqueue(id);
#line 69
...
#line 56
  result = SchedulerBasicP$TaskBasic$postTask(CC2420TinyosNetworkP$grantTask);
#line 56
...
#line 78
  result = CC2420TinyosNetworkP$Resource$request(CC2420ActiveMessageC$CC2420_AM_SEND_ID);
#line 78
...
#line 78
# 187 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline error_t CC2420TinyosNetworkP$Resource$release(uint8_t id)
#line 187
{
  if (CC2420TinyosNetworkP$TINYOS_N_NETWORKS > 1) {
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP$Resource$granted(uint8_t arg_0x262a7d0){
#line 92
  switch (arg_0x262a7d0) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP$Resource$default$granted(arg_0x262a7d0);
#line 92
      break;
#line 92
    }
...
#line 60
  result = /*CC2420TinyosNetworkC.FcfsResourceQueueC*/FcfsResourceQueueC$0$FcfsQueue$dequeue();
#line 60
...
#line 67
  result = CC2420TinyosNetworkP$BareReceive$default$receive(msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Snoop$receive(am_id_t arg_0x267f148, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
    result = CC2420ActiveMessageP$Snoop$default$receive(arg_0x267f148, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Receive$receive(am_id_t arg_0x2680a80, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
    result = CC2420ActiveMessageP$Receive$default$receive(arg_0x2680a80, msg, payload, len);
#line 67
...
#line 75
  result = CC2420PacketP$CC2420Packet$getNetwork(p_msg);
#line 75
...
#line 47
# 121 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline message_t *CC2420TinyosNetworkP$SubReceive$receive(message_t *msg, void *payload, uint8_t len)
#line 121
{
  ...
  if (CC2420TinyosNetworkP$CC2420Packet$getNetwork(msg) == 0x3f) {
      return CC2420TinyosNetworkP$ActiveReceive$receive(msg, msg->data, len - AM_OVERHEAD);
    }
  else 
#line 129
    {
      return CC2420TinyosNetworkP$BareReceive$receive(msg, payload, len);
    }
}
...
#line 696
      CC2420ReceiveP$m_p_rx_buf = CC2420ReceiveP$Receive$receive(CC2420ReceiveP$m_p_rx_buf, (uint8_t *)CC2420ReceiveP$m_p_rx_buf->data - AM_OVERHEAD, 
      length - CC2420_SIZE);
    }
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 699
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$granted(uint8_t arg_0x2265ba0){
#line 92
  switch (arg_0x2265ba0) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$default$granted(arg_0x2265ba0);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$Resource$granted(uint8_t arg_0x1abb230){
#line 92
  switch (arg_0x1abb230) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$1$Resource$default$granted(arg_0x1abb230);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$sendDone(uint8_t arg_0x22601b8, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x22601b8) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$default$sendDone(arg_0x22601b8, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$readDone(uint8_t arg_0x21a7698, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x21a7698) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP$Fifo$default$readDone(arg_0x21a7698, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestInitialBackoff(am_id_t arg_0x267c230, message_t * msg){
#line 81
    CC2420ActiveMessageP$RadioBackoff$default$requestInitialBackoff(arg_0x267c230, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$writeDone(uint8_t arg_0x21a7698, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x21a7698) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP$Fifo$default$writeDone(arg_0x21a7698, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP$Resource$granted(uint8_t arg_0x21a8bf0){
#line 92
  switch (arg_0x21a8bf0) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP$Resource$default$granted(arg_0x21a8bf0);
#line 92
      break;
#line 92
    }
...
# 202 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline void CC2420TinyosNetworkP$BareSend$default$sendDone(message_t *msg, error_t error)
#line 202
{
}
...
#line 89
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP$AMSend$sendDone(am_id_t arg_0x26800c0, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$1$AMSend$sendDone(arg_0x26800c0, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
#line 110
  result = CC2420TinyosNetworkP$Resource$release(CC2420ActiveMessageC$CC2420_AM_SEND_ID);
#line 110
...
#line 89
# 112 "/opt/tinyos-2.x/tos/chips/cc2420/lowpan/CC2420TinyosNetworkP.nc"
static inline void CC2420TinyosNetworkP$SubSend$sendDone(message_t *msg, error_t error)
#line 112
{
  if (CC2420TinyosNetworkP$CC2420Packet$getNetwork(msg) == 0x3f) {
...
#line 117
  SenseAcousticC$AMControl$stopDone(error);
#line 117
}
#line 117
...
#line 92
  SenseAcousticC$AMControl$startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 121 "/opt/tinyos-2.x/tos/chips/msp430/adc12/HplAdc12P.nc"
static inline bool HplAdc12P$HplAdc12$isBusy(void )
#line 121
{
#line 121
...
#line 118
# 69 "/opt/tinyos-2.x/tos/chips/msp430/adc12/HplAdc12P.nc"
static inline adc12ctl0_t HplAdc12P$HplAdc12$getCtl0(void )
#line 69
{
...
#line 95
# 77 "/opt/tinyos-2.x/tos/chips/msp430/adc12/HplAdc12P.nc"
static inline void HplAdc12P$HplAdc12$setMCtl(uint8_t i, adc12memctl_t memControl)
#line 77
{
...
# 84 "/opt/tinyos-2.x/tos/chips/msp430/adc12/Msp430Adc12SingleChannel.nc"
inline static error_t AdcP$SingleChannel$configureSingle(uint8_t arg_0x1d16e60, const msp430adc12_channel_config_t * config){
#line 84
  unsigned char result;
#line 84

#line 84
  switch (arg_0x1d16e60) {
#line 84
    case /*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$CLIENT:
#line 84
      result = Msp430Adc12ImplP$SingleChannel$configureSingle(/*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID, config);
#line 84
      break;
#line 84
    default:
#line 84
      result = AdcP$SingleChannel$default$configureSingle(arg_0x1d16e60, config);
#line 84
      break;
#line 84
    }
...
#line 84
# 32 "SBT80_ADCconfigP.nc"
static inline const msp430adc12_channel_config_t *SBT80_ADCconfigP$ADC1$getConfiguration(void )
#line 32
{
  return &SBT80_ADCconfigP$config_ADC1;
}
...
# 58 "/opt/tinyos-2.x/tos/interfaces/AdcConfigure.nc"
inline static AdcP$Config$adc_config_t AdcP$Config$getConfiguration(uint8_t arg_0x1d258e8){
#line 58
  struct __nesc_unnamed4272 const *result;
#line 58

#line 58
  switch (arg_0x1d258e8) {
#line 58
    case /*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$CLIENT:
#line 58
      result = SBT80_ADCconfigP$ADC1$getConfiguration();
#line 58
      break;
#line 58
    default:
#line 58
      result = AdcP$Config$default$getConfiguration(arg_0x1d258e8);
#line 58
      break;
#line 58
    }
...
{
#line 46
  union /*Msp430TimerC.Msp430TimerA1*/Msp430TimerCapComP$1$__nesc_unnamed4407 {
#line 46
...
# 103 "/opt/tinyos-2.x/tos/chips/msp430/adc12/HplAdc12P.nc"
static inline void HplAdc12P$HplAdc12$startConversion(void )
#line 103
{
...
#line 82
  struct __nesc_unnamed4273 result;
#line 82
...
# 189 "/opt/tinyos-2.x/tos/chips/msp430/adc12/Msp430Adc12SingleChannel.nc"
inline static error_t AdcP$SingleChannel$getData(uint8_t arg_0x1d16e60){
#line 189
  unsigned char result;
#line 189
...
#line 189
    case /*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$CLIENT:
#line 189
      result = Msp430Adc12ImplP$SingleChannel$getData(/*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID);
#line 189
      break;
#line 189
    default:
#line 189
      result = AdcP$SingleChannel$default$getData(arg_0x1d16e60);
#line 189
      break;
#line 189
    }
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceConfigure$unconfigure(uint8_t arg_0x1e4c030){
#line 55
    /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceConfigure$default$unconfigure(arg_0x1e4c030);
#line 55
}
#line 55
...
# 81 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static bool SenseAcousticC$SpeechTimer$isRunning(void ){
#line 81
  unsigned char result;
#line 81

#line 81
  result = /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$isRunning(2U);
#line 81
...
#line 81
#line 67
inline static void SenseAcousticC$SpeechTimer$stop(void ){
#line 67
...
#line 67
#line 62
inline static void SenseAcousticC$SpeechTimer$startOneShot(uint32_t dt){
#line 62
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void Msp430RefVoltArbiterImplP$ClientResource$granted(uint8_t arg_0x1e94610){
#line 92
  switch (arg_0x1e94610) {
#line 92
    case /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID:
#line 92
      AdcP$ResourceRead$granted(/*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$CLIENT);
#line 92
      break;
#line 92
    default:
#line 92
      Msp430RefVoltArbiterImplP$ClientResource$default$granted(arg_0x1e94610);
#line 92
      break;
#line 92
    }
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t Msp430RefVoltArbiterImplP$AdcResource$request(uint8_t arg_0x1ed80e8){
#line 78
  unsigned char result;
#line 78

#line 78
  switch (arg_0x1ed80e8) {
#line 78
    case /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID:
#line 78
      result = /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$Resource$request(/*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID);
#line 78
      break;
#line 78
    default:
#line 78
      result = Msp430RefVoltArbiterImplP$AdcResource$default$request(arg_0x1ed80e8);
#line 78
      break;
#line 78
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t Msp430RefVoltArbiterImplP$AdcResource$release(uint8_t arg_0x1ed80e8){
#line 110
  unsigned char result;
#line 110
...
#line 110
    case /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID:
#line 110
      result = /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$Resource$release(/*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID);
#line 110
      break;
#line 110
    default:
#line 110
      result = Msp430RefVoltArbiterImplP$AdcResource$default$release(arg_0x1ed80e8);
#line 110
      break;
#line 110
    }
...
#line 83
# 58 "/opt/tinyos-2.x/tos/interfaces/AdcConfigure.nc"
inline static /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfUp$adc_config_t /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfUp$getConfiguration(void ){
#line 58
  struct __nesc_unnamed4272 const *result;
#line 58
...
static inline const msp430adc12_channel_config_t */*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfSub$getConfiguration(void )
{
  return /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfUp$getConfiguration();
}
...
# 58 "/opt/tinyos-2.x/tos/interfaces/AdcConfigure.nc"
inline static Msp430RefVoltArbiterImplP$Config$adc_config_t Msp430RefVoltArbiterImplP$Config$getConfiguration(uint8_t arg_0x1ed7b50){
#line 58
  struct __nesc_unnamed4272 const *result;
#line 58

#line 58
  switch (arg_0x1ed7b50) {
#line 58
    case /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID:
#line 58
      result = /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient.Msp430Adc12ConfAlertC*/Msp430Adc12ConfAlertC$0$ConfSub$getConfiguration();
#line 58
      break;
#line 58
    default:
#line 58
      result = Msp430RefVoltArbiterImplP$Config$default$getConfiguration(arg_0x1ed7b50);
#line 58
      break;
#line 58
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$Resource$granted(uint8_t arg_0x1e4e930){
#line 92
  switch (arg_0x1e4e930) {
#line 92
    case /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID:
#line 92
      Msp430RefVoltArbiterImplP$AdcResource$granted(/*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID);
#line 92
      break;
#line 92
    default:
#line 92
      /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$Resource$default$granted(arg_0x1e4e930);
#line 92
      break;
#line 92
    }
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceConfigure$configure(uint8_t arg_0x1e4c030){
#line 49
    /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceConfigure$default$configure(arg_0x1e4c030);
#line 49
}
#line 49
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceRequested$requested(uint8_t arg_0x1e4d3f0){
#line 43
    /*Msp430Adc12P.Arbiter.Arbiter*/SimpleArbiterP$0$ResourceRequested$default$requested(arg_0x1e4d3f0);
#line 43
}
#line 43
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static void AdcP$Read$readDone(uint8_t arg_0x1cf1010, error_t result, AdcP$Read$val_t val){
#line 63
  switch (arg_0x1cf1010) {
#line 63
    case /*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$CLIENT:
#line 63
      SenseAcousticC$ReadMIC$readDone(result, val);
#line 63
      break;
#line 63
    default:
#line 63
      AdcP$Read$default$readDone(arg_0x1cf1010, result, val);
#line 63
      break;
#line 63
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t AdcP$ResourceRead$release(uint8_t arg_0x1d27130){
#line 110
  unsigned char result;
#line 110

#line 110
  switch (arg_0x1d27130) {
#line 110
    case /*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$CLIENT:
#line 110
      result = Msp430RefVoltArbiterImplP$ClientResource$release(/*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID);
#line 110
      break;
#line 110
    default:
#line 110
      result = AdcP$ResourceRead$default$release(arg_0x1d27130);
#line 110
      break;
#line 110
    }
...
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t SenseAcousticC$getData$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(SenseAcousticC$getData);
#line 56
...
#line 56
# 116 "SenseAcousticC.nc"
static inline void SenseAcousticC$WakeupTimer$fired(void )
#line 116
{
  SenseAcousticC$ChannelNo = 0;
  SenseAcousticC$getData$postTask();
}
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void SenseAcousticC$WakeupTimer$startPeriodic(uint32_t dt){
#line 53
...
inline static void SenseAcousticC$Leds$led2Off(void ){
#line 83
  LedsP$Leds$led2Off();
#line 83
}
#line 83
# 123 "SenseAcousticC.nc"
static inline void SenseAcousticC$CalibrationTimer$fired(void )
#line 123
{
  if (SenseAcousticC$calibrationIndex < 30) {
      SenseAcousticC$getData$postTask();
      SenseAcousticC$calibrationIndex++;

      SenseAcousticC$CalibrationTimer$startOneShot(1000);
    }
  else {
      SenseAcousticC$calibrating = FALSE;
      SenseAcousticC$Leds$led2Off();

      SenseAcousticC$calibrationAverage = SenseAcousticC$calibrationData / SenseAcousticC$calibrationIndex;
      printf("Calibration average: %u\n", SenseAcousticC$calibrationAverage);

      SenseAcousticC$stddev = 0;


      while (SenseAcousticC$index < SenseAcousticC$calibrationIndex) {
          SenseAcousticC$stddev += (SenseAcousticC$calibrationAverage - SenseAcousticC$calibrationArray[SenseAcousticC$index]) * (SenseAcousticC$calibrationAverage - SenseAcousticC$calibrationArray[SenseAcousticC$index]);
          SenseAcousticC$index++;
        }
      SenseAcousticC$stddev = SenseAcousticC$stddev / SenseAcousticC$calibrationIndex;
      SenseAcousticC$stddev = sqrtf(SenseAcousticC$stddev);
      printf("Calibration stddev: %4u\n", SenseAcousticC$stddev);

      SenseAcousticC$upperBound = SenseAcousticC$calibrationAverage + 2 * SenseAcousticC$stddev;
      SenseAcousticC$lowerBound = SenseAcousticC$calibrationAverage - 2 * SenseAcousticC$stddev;


      SenseAcousticC$WakeupTimer$startPeriodic(1000);
    }
}

# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t SenseAcousticC$sendGreenPacket$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(SenseAcousticC$sendGreenPacket);
#line 56
...
#line 56
# 157 "SenseAcousticC.nc"
static inline void SenseAcousticC$SpeechTimer$fired(void )
#line 157
{

  SenseAcousticC$sendGreenPacket$postTask();
}
...
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x1ca6dd8){
#line 72
  switch (arg_0x1ca6dd8) {
#line 72
    case 0U:
#line 72
      SenseAcousticC$WakeupTimer$fired();
#line 72
      break;
#line 72
    case 1U:
#line 72
      SenseAcousticC$CalibrationTimer$fired();
#line 72
      break;
#line 72
    case 2U:
#line 72
      SenseAcousticC$SpeechTimer$fired();
#line 72
      break;
#line 72
    case 3U:
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x1ca6dd8);
#line 72
      break;
#line 72
    }
...
#line 151
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x1b62010, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char result;
#line 69

#line 69
  result = /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$AMSend$send(arg_0x1b62010, addr, msg, len);
#line 69
...
# 23 "/opt/tinyos-2.x/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$dataLinkLength(uart_id_t arg_0x175ecd0, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char result;
#line 23

#line 23
  switch (arg_0x175ecd0) {
#line 23
...
#line 23
    default:
#line 23
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$dataLinkLength(arg_0x175ecd0, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$offset(uart_id_t arg_0x175ecd0){
#line 15
  unsigned char result;
#line 15
...
#line 15
    default:
#line 15
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$offset(arg_0x175ecd0);
#line 15
      break;
#line 15
    }
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x1b2f5d0, message_t * msg, error_t error){
#line 89
  switch (arg_0x1b2f5d0) {
#line 89
    case 0U:
...
#line 89
    default:
#line 89
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x1b2f5d0, msg, error);
#line 89
      break;
#line 89
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP$0$Resource$granted(uint8_t arg_0x1815580){
#line 92
  switch (arg_0x1815580) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430Uart1P.UartP*/Msp430UartP$0$Resource$default$granted(arg_0x1815580);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$0$Resource$granted(uint8_t arg_0x1abb230){
#line 92
  switch (arg_0x1abb230) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$0$Resource$default$granted(arg_0x1abb230);
#line 92
      break;
#line 92
    }
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$configure(uint8_t arg_0x1ab8030){
#line 49
  switch (arg_0x1ab8030) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$configure(arg_0x1ab8030);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP$0$Msp430UartConfigure$getConfig(uint8_t arg_0x18386c0){
#line 39
  union __nesc_unnamed4289 *result;
#line 39

#line 39
  switch (arg_0x18386c0) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C$0$CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      result = /*Msp430Uart1P.UartP*/Msp430UartP$0$Msp430UartConfigure$default$getConfig(arg_0x18386c0);
#line 39
      break;
#line 39
    }
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$AMSend$sendDone(am_id_t arg_0x1639688, message_t * msg, error_t error){
#line 99
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x1639688, msg, error);
#line 99
}
#line 99
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Send$sendDone(uart_id_t arg_0x175e1d0, message_t * msg, error_t error){
#line 89
  switch (arg_0x175e1d0) {
#line 89
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 89
...
#line 89
    default:
#line 89
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Send$default$sendDone(arg_0x175e1d0, msg, error);
#line 89
      break;
#line 89
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$Receive$receive(am_id_t arg_0x1652068, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
    result = /*SerialActiveMessageC.AM*/SerialActiveMessageP$0$Receive$default$receive(arg_0x1652068, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Receive$receive(uart_id_t arg_0x173cb58, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
  switch (arg_0x173cb58) {
#line 67
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 67
...
#line 67
    default:
#line 67
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$Receive$default$receive(arg_0x173cb58, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 31 "/opt/tinyos-2.x/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$upperLength(uart_id_t arg_0x175ecd0, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char result;
#line 31
...
#line 31
    default:
#line 31
      result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP$0$PacketInfo$default$upperLength(arg_0x175ecd0, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$unconfigure(uint8_t arg_0x1ab8030){
#line 55
  switch (arg_0x1ab8030) {
#line 55
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C$0$CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$unconfigure(arg_0x1ab8030);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$release(uint8_t arg_0x183abb0){
#line 110
  unsigned char result;
#line 110

#line 110
  switch (arg_0x183abb0) {
#line 110
    case /*PlatformSerialC.UartC*/Msp430Uart1C$0$CLIENT_ID:
#line 110
...
#line 110
    default:
#line 110
      result = /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$default$release(arg_0x183abb0);
#line 110
      break;
#line 110
    }
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$isOwner(uint8_t arg_0x183abb0){
#line 118
  unsigned char result;
#line 118
...
#line 118
    default:
#line 118
      result = /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$default$isOwner(arg_0x183abb0);
#line 118
      break;
#line 118
    }
...
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t SenseAcousticC$calibrateAcoustic$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(SenseAcousticC$calibrateAcoustic);
#line 56
...
#line 56
inline static error_t SenseAcousticC$sendRedPacket$postTask(void ){
#line 56
  unsigned char result;
#line 56

#line 56
  result = SchedulerBasicP$TaskBasic$postTask(SenseAcousticC$sendRedPacket);
#line 56
...
# 85 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430GeneralIO.nc"
inline static void SenseAcousticC$SBcontrol$selectIOFunc(void ){
#line 85
  /*HplMsp430GeneralIOC.P23*/HplMsp430GeneralIOP$11$IO$selectIOFunc();
#line 85
}
#line 85
# 52 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430GeneralIOP.nc"
...
# 71 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430GeneralIO.nc"
inline static void SenseAcousticC$SBcontrol$makeOutput(void ){
#line 71
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/pins/HplMsp430GeneralIO.nc"
inline static void SenseAcousticC$SBcontrol$clr(void ){
#line 39
...
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t SenseAcousticC$AMControl$start(void ){
#line 83
  unsigned char result;
#line 83
...
#line 83
# 98 "SenseAcousticC.nc"
static inline void SenseAcousticC$Boot$booted(void )
#line 98
{
  SenseAcousticC$AMControl$start();


  SenseAcousticC$SBcontrol$clr();
  SenseAcousticC$SBcontrol$makeOutput();
  SenseAcousticC$SBcontrol$selectIOFunc();


  SenseAcousticC$sendRedPacket$postTask();


  SenseAcousticC$calibrateAcoustic$postTask();
}

# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
inline static void PrintfP$Boot$booted(void ){
#line 49
  SenseAcousticC$Boot$booted();
#line 49
}
#line 49
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$immediateRequested(uint8_t arg_0x1abbc58){
#line 51
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$immediateRequested(arg_0x1abbc58);
#line 51
}
#line 51
# 90 "/opt/tinyos-2.x/tos/system/ArbiterP.nc"
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$immediateRequest(uint8_t arg_0x183abb0){
#line 87
  unsigned char result;
#line 87
...
#line 87
    default:
#line 87
      result = /*Msp430Uart1P.UartP*/Msp430UartP$0$UsartResource$default$immediateRequest(arg_0x183abb0);
#line 87
      break;
#line 87
    }
...
inline static void SenseAcousticC$Leds$led2On(void ){
#line 78
  LedsP$Leds$led2On();
#line 78
}
#line 78
# 179 "SenseAcousticC.nc"
static inline void SenseAcousticC$calibrateAcoustic$runTask(void )
#line 179
{
  SenseAcousticC$calibrationIndex = 0;
  SenseAcousticC$calibrationData = 0;
  SenseAcousticC$calibrationAverage = 0;
  SenseAcousticC$calibrating = TRUE;
  SenseAcousticC$Leds$led2On();
  SenseAcousticC$CalibrationTimer$startOneShot(1000);
}
...
inline static void SenseAcousticC$Leds$led1On(void ){
#line 61
  LedsP$Leds$led1On();
#line 61
}
#line 61
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t SenseAcousticC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char result;
#line 69

#line 69
  result = /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(addr, msg, len);
#line 69
...
#line 114
  result = CC2420TinyosNetworkP$ActiveSend$getPayload(msg, len);
#line 114
...
# 115 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
inline static void * SenseAcousticC$Packet$getPayload(message_t * msg, uint8_t len){
#line 115
  void *result;
#line 115
...
#line 115
# 210 "SenseAcousticC.nc"
static inline void SenseAcousticC$sendGreenPacket$runTask(void )
#line 210
{


  SenseToRadioMsg *ptrpkt = (SenseToRadioMsg *)SenseAcousticC$Packet$getPayload(&SenseAcousticC$pkt, SenseAcousticC$len);

#line 214
  __nesc_hton_uint16(ptrpkt->data[SenseAcousticC$ChannelNo].data, 0x1111);
  __nesc_hton_uint16(ptrpkt->data[SenseAcousticC$ChannelNo + 1].data, 0xDEAD);


  if (!SenseAcousticC$busy) {
      if (SenseAcousticC$AMSend$send(AM_BROADCAST_ADDR, &SenseAcousticC$pkt, sizeof(SenseToRadioMsg )) == SUCCESS) {
          SenseAcousticC$Leds$led1On();
          SenseAcousticC$busy = TRUE;
        }
    }
}
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
# 151 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
...
#line 185
{
  __nesc_hton_leuint8(CC2420ActiveMessageP$CC2420PacketBody$getHeader(msg)->length.data, len + CC2420_SIZE + AM_OVERHEAD);
}
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char result;
#line 64
...
inline static void SenseAcousticC$Leds$led0On(void ){
#line 45
  LedsP$Leds$led0On();
#line 45
}
#line 45
# 194 "SenseAcousticC.nc"
static inline void SenseAcousticC$sendRedPacket$runTask(void )
#line 194
{
...
#line 197
  __nesc_hton_uint16(ptrpkt->data[SenseAcousticC$ChannelNo].data, 0x0000);
  __nesc_hton_uint16(ptrpkt->data[SenseAcousticC$ChannelNo + 1].data, 0xDEAD);


  if (!SenseAcousticC$busy) {
      if (SenseAcousticC$AMSend$send(AM_BROADCAST_ADDR, &SenseAcousticC$pkt, sizeof(SenseToRadioMsg )) == SUCCESS) {
          SenseAcousticC$Leds$led0On();
          SenseAcousticC$busy = TRUE;
        }
    }
}
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t AdcP$ResourceRead$request(uint8_t arg_0x1d27130){
#line 78
  unsigned char result;
#line 78
...
#line 78
    case /*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$CLIENT:
#line 78
      result = Msp430RefVoltArbiterImplP$ClientResource$request(/*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID);
#line 78
      break;
#line 78
    default:
#line 78
      result = AdcP$ResourceRead$default$request(arg_0x1d27130);
#line 78
      break;
#line 78
    }
...
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static error_t SenseAcousticC$ReadMIC$read(void ){
#line 55
  unsigned char result;
#line 55

#line 55
  result = AdcP$Read$read(/*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$CLIENT);
#line 55
...
#line 55
# 189 "SenseAcousticC.nc"
static inline void SenseAcousticC$getData$runTask(void )
#line 189
{
  SenseAcousticC$ReadMIC$read();
}
...
{
#line 46
  union /*Msp430TimerC.Msp430TimerB0*/Msp430TimerCapComP$3$__nesc_unnamed4408 {
#line 46
...
{
#line 46
  union /*Msp430TimerC.Msp430TimerB2*/Msp430TimerCapComP$5$__nesc_unnamed4409 {
#line 46
...
#line 51
  result = /*CC2420TinyosNetworkC.FcfsResourceQueueC*/FcfsResourceQueueC$0$Init$init();
#line 51
...
#line 51
  result = ecombine(result, /*Msp430UsartShare0P.ArbiterC.Queue*/FcfsResourceQueueC$2$Init$init());
#line 51
...
#line 51
  result = ecombine(result, /*Msp430UsartShare1P.ArbiterC.Queue*/FcfsResourceQueueC$1$Init$init());
#line 51
...
# 79 "/opt/tinyos-2.x/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$receivedByte(uint8_t arg_0x183b770, uint8_t byte){
#line 79
  switch (arg_0x183b770) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C$0$CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$default$receivedByte(arg_0x183b770, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$receiveDone(uint8_t arg_0x183b770, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x183b770) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C$0$CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$default$receiveDone(arg_0x183b770, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP$0$Interrupts$rxDone(uint8_t arg_0x1a88200, uint8_t data){
#line 54
  switch (arg_0x1a88200) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C$0$CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$rxDone(arg_0x1a88200, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$sendDone(uint8_t arg_0x183b770, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x183b770) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C$0$CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP$0$UartStream$default$sendDone(arg_0x183b770, buf, len, error);
#line 57
      break;
#line 57
    }
...
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP$0$Interrupts$txDone(uint8_t arg_0x1a88200){
#line 49
  switch (arg_0x1a88200) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$txDone(arg_0x1a88200);
#line 49
      break;
#line 49
    }
...
# 227 "/opt/tinyos-2.x/tos/chips/msp430/adc12/Msp430Adc12SingleChannel.nc"
inline static uint16_t * Msp430Adc12ImplP$SingleChannel$multipleDataReady(uint8_t arg_0x1d7d2a8, uint16_t * buffer, uint16_t numSamples){
#line 227
  unsigned int *result;
#line 227

#line 227
  switch (arg_0x1d7d2a8) {
#line 227
    case /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID:
#line 227
      result = AdcP$SingleChannel$multipleDataReady(/*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$CLIENT, buffer, numSamples);
#line 227
      break;
#line 227
    default:
#line 227
      result = Msp430Adc12ImplP$SingleChannel$default$multipleDataReady(arg_0x1d7d2a8, buffer, numSamples);
#line 227
      break;
#line 227
    }
...
# 105 "/opt/tinyos-2.x/tos/chips/msp430/adc12/Msp430Adc12MultiChannel.nc"
inline static void Msp430Adc12ImplP$MultiChannel$dataReady(uint8_t arg_0x1d7c010, uint16_t *buffer, uint16_t numSamples){
#line 105
    Msp430Adc12ImplP$MultiChannel$default$dataReady(arg_0x1d7c010, buffer, numSamples);
#line 105
}
#line 105
...
# 206 "/opt/tinyos-2.x/tos/chips/msp430/adc12/Msp430Adc12SingleChannel.nc"
inline static error_t Msp430Adc12ImplP$SingleChannel$singleDataReady(uint8_t arg_0x1d7d2a8, uint16_t data){
#line 206
  unsigned char result;
#line 206
...
#line 206
    case /*SenseAcousticAppC.MIC.AdcRC1.Msp430AdcClient*/Msp430Adc12ClientAutoRVGC$0$ID:
#line 206
      result = AdcP$SingleChannel$singleDataReady(/*SenseAcousticAppC.MIC.AdcRC1*/AdcReadClientC$0$CLIENT, data);
#line 206
      break;
#line 206
    default:
#line 206
      result = Msp430Adc12ImplP$SingleChannel$default$singleDataReady(arg_0x1d7d2a8, data);
#line 206
      break;
#line 206
    }
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/adc12/Msp430Adc12Overflow.nc"
inline static void Msp430Adc12ImplP$Overflow$conversionTimeOverflow(uint8_t arg_0x1d7c900){
#line 54
    Msp430Adc12ImplP$Overflow$default$conversionTimeOverflow(arg_0x1d7c900);
#line 54
}
#line 54
...
# 49 "/opt/tinyos-2.x/tos/chips/msp430/adc12/Msp430Adc12Overflow.nc"
inline static void Msp430Adc12ImplP$Overflow$memOverflow(uint8_t arg_0x1d7c900){
#line 49
    Msp430Adc12ImplP$Overflow$default$memOverflow(arg_0x1d7c900);
#line 49
}
#line 49
...
#line 85
# 98 "/opt/tinyos-2.x/tos/chips/msp430/adc12/HplAdc12P.nc"
static inline void HplAdc12P$HplAdc12$resetIFGs(void )
#line 98
{
  HplAdc12P$ADC12IV = 0;
...
# 66 "/opt/tinyos-2.x/tos/interfaces/ReadNow.nc"
inline static void AdcP$ReadNow$readDone(uint8_t arg_0x1d285a0, error_t result, AdcP$ReadNow$val_t val){
#line 66
    AdcP$ReadNow$default$readDone(arg_0x1d285a0, result, val);
#line 66
}
#line 66
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$1$Interrupts$rxDone(uint8_t arg_0x1a88200, uint8_t data){
#line 54
  switch (arg_0x1a88200) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$1$Interrupts$default$rxDone(arg_0x1a88200, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$1$I2CInterrupts$fired(uint8_t arg_0x1a871d8){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$1$I2CInterrupts$default$fired(arg_0x1a871d8);
#line 39
}
#line 39
...
# 49 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$1$Interrupts$txDone(uint8_t arg_0x1a88200){
#line 49
  switch (arg_0x1a88200) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$1$Interrupts$default$txDone(arg_0x1a88200);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$fired(uint8_t arg_0x15704b0){
#line 28
  switch (arg_0x15704b0) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$default$fired(arg_0x15704b0);
#line 28
      break;
#line 28
    }
...
# 139 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static void CC2420PacketP$PacketTimeStamp32khz$clear(message_t *msg)
{
...
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x13d63c0){
#line 64
  switch (arg_0x13d63c0) {
#line 64
    case SenseAcousticC$getData:
#line 64
      SenseAcousticC$getData$runTask();
#line 64
      break;
#line 64
    case SenseAcousticC$sendRedPacket:
#line 64
      SenseAcousticC$sendRedPacket$runTask();
#line 64
      break;
#line 64
    case SenseAcousticC$sendGreenPacket:
#line 64
      SenseAcousticC$sendGreenPacket$runTask();
#line 64
      break;
#line 64
    case SenseAcousticC$calibrateAcoustic:
#line 64
      SenseAcousticC$calibrateAcoustic$runTask();
#line 64
      break;
#line 64
    case SerialP$RunTx:
...
#line 64
    default:
#line 64
      SchedulerBasicP$TaskBasic$default$runTask(arg_0x13d63c0);
#line 64
      break;
#line 64
    }
...
#line 64
# 169 "SenseAcousticC.nc"
static void SenseAcousticC$AMSend$sendDone(message_t *msg, error_t error)
#line 169
{
  if (&SenseAcousticC$pkt == msg) {
      SenseAcousticC$busy = FALSE;

      SenseAcousticC$Leds$led0Off();
      SenseAcousticC$Leds$led1Off();
    }
}
...
# 108 "/opt/tinyos-2.x/tos/chips/cc2420/packet/CC2420PacketP.nc"
static void CC2420PacketP$CC2420Packet$setNetwork(message_t *p_msg, uint8_t networkId)
#line 108
{
...
# 83 "/opt/tinyos-2.x/tos/chips/msp430/adc12/HplAdc12P.nc"
static adc12memctl_t HplAdc12P$HplAdc12$getMCtl(uint8_t i)
#line 83
{
...
# 227 "SenseAcousticC.nc"
static void SenseAcousticC$ReadMIC$readDone(error_t result, uint16_t data)
#line 227
{
  if (SenseAcousticC$calibrating) {
      SenseAcousticC$calibrationData = SenseAcousticC$calibrationData + data;
      SenseAcousticC$calibrationArray[SenseAcousticC$calibrationIndex] = data;
      printf("%4u\n", data);
    }
  else {

      if (data < SenseAcousticC$lowerBound || data > SenseAcousticC$upperBound) {

          SenseAcousticC$sendRedPacket$postTask();


          if (SenseAcousticC$SpeechTimer$isRunning()) {
              printf("SpeechTimer was running, but still talking...turning timer off.\n");
              SenseAcousticC$SpeechTimer$stop();
            }
        }
      else 
        {
          ...
          if (SenseAcousticC$SpeechTimer$isRunning()) {
          ...
          else 
            {
              ...
              SenseAcousticC$SpeechTimer$startOneShot(10);
            }
        }
    }
}
...
#line 47
{
  /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(msg, dest);
  /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(msg, 6);
  return /*SenseAcousticAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(msg, len);
}

# 108 "/opt/tinyos-2.x/tos/chips/msp430/adc12/HplAdc12P.nc"
static void HplAdc12P$HplAdc12$stopConversion(void )
#line 108
{
...
# 123 "/opt/tinyos-2.x/tos/chips/msp430/adc12/HplAdc12P.nc"
